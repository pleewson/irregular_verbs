...
public class irregularVerbs {
    protected static String[][] irregularVerbsArray = new String [70][4];
    //if you comment array indexes change value of array[] above
        ...
        static {
            ...
            irregularVerbsArray[14][3] = "śnić/marzyć";
            ...
            irregularVerbsArray[18][3] = "padać/upadać";
            ...
            irregularVerbsArray[41][0] = "put";
            irregularVerbsArray[41][1] = "put";
            irregularVerbsArray[41][2] = "put";
            irregularVerbsArray[41][3] = "kłaść";

            irregularVerbsArray[42][0] = "read";
            irregularVerbsArray[42][1] = "read";
            irregularVerbsArray[42][2] = "read";
            irregularVerbsArray[42][3] = "czytać";

            irregularVerbsArray[43][0] = "ride";
            irregularVerbsArray[43][1] = "rode";
            irregularVerbsArray[43][2] = "ridden";
            irregularVerbsArray[43][3] = "jeździć";

            irregularVerbsArray[44][0] = "ring";
            irregularVerbsArray[44][1] = "rang";
            irregularVerbsArray[44][2] = "rung";
            irregularVerbsArray[44][3] = "dzwonić";

            irregularVerbsArray[45][0] = "run";
            irregularVerbsArray[45][1] = "ran";
            irregularVerbsArray[45][2] = "run";
            irregularVerbsArray[45][3] = "biec";

            irregularVerbsArray[46][0] = "say";
            irregularVerbsArray[46][1] = "said";
            irregularVerbsArray[46][2] = "said";
            irregularVerbsArray[46][3] = "mówić";

            irregularVerbsArray[47][0] = "see";
            irregularVerbsArray[47][1] = "saw";
            irregularVerbsArray[47][2] = "seen";
            irregularVerbsArray[47][3] = "widzieć";

            irregularVerbsArray[48][0] = "sell";
            irregularVerbsArray[48][1] = "sold";
            irregularVerbsArray[48][2] = "sold";
            irregularVerbsArray[48][3] = "sprzedawać";

            irregularVerbsArray[49][0] = "send";
            irregularVerbsArray[49][1] = "sent";
            irregularVerbsArray[49][2] = "sent";
            irregularVerbsArray[49][3] = "wysyłać";

            irregularVerbsArray[50][0] = "show";
            irregularVerbsArray[50][1] = "showed";
            irregularVerbsArray[50][2] = "shown";
            irregularVerbsArray[50][3] = "pokazywać";

            irregularVerbsArray[51][0] = "shut";
            irregularVerbsArray[51][1] = "shut";
            irregularVerbsArray[51][2] = "shut";
            irregularVerbsArray[51][3] = "zamykać";

            irregularVerbsArray[52][0] = "sing";
            irregularVerbsArray[52][1] = "sang";
            irregularVerbsArray[52][2] = "sung";
            irregularVerbsArray[52][3] = "śpiewać";

            irregularVerbsArray[53][0] = "sit";
            irregularVerbsArray[53][1] = "sat";
            irregularVerbsArray[53][2] = "sat";
            irregularVerbsArray[53][3] = "siedzieć";

            irregularVerbsArray[54][0] = "sleep";
            irregularVerbsArray[54][1] = "slept";
            irregularVerbsArray[54][2] = "slept";
            irregularVerbsArray[54][3] = "spać";

            irregularVerbsArray[55][0] = "speak";
            irregularVerbsArray[55][1] = "spoke";
            irregularVerbsArray[55][2] = "spoken";
            irregularVerbsArray[55][3] = "mówić";

            irregularVerbsArray[56][0] = "spend";
            irregularVerbsArray[56][1] = "spent";
            irregularVerbsArray[56][2] = "spent";
            irregularVerbsArray[56][3] = "spędzać/wydawać";

            irregularVerbsArray[57][0] = "stand";
            irregularVerbsArray[57][1] = "stood";
            irregularVerbsArray[57][2] = "stood";
            irregularVerbsArray[57][3] = "stać";

            irregularVerbsArray[58][0] = "steal";
            irregularVerbsArray[58][1] = "stole";
            irregularVerbsArray[58][2] = "stolen";
            irregularVerbsArray[58][3] = "kraść";

            irregularVerbsArray[59][0] = "swim";
            irregularVerbsArray[59][1] = "swam";
            irregularVerbsArray[59][2] = "swum";
            irregularVerbsArray[59][3] = "pływać";

            irregularVerbsArray[60][0] = "take";
            irregularVerbsArray[60][1] = "took";
            irregularVerbsArray[60][2] = "taken";
            irregularVerbsArray[60][3] = "brać";

            irregularVerbsArray[61][0] = "teach";
            irregularVerbsArray[61][1] = "taught";
            irregularVerbsArray[61][2] = "taught";
            irregularVerbsArray[61][3] = "uczyć";

            irregularVerbsArray[62][0] = "tell";
            irregularVerbsArray[62][1] = "told";
            irregularVerbsArray[62][2] = "told";
            irregularVerbsArray[62][3] = "powiedzieć";

            irregularVerbsArray[63][0] = "think";
            irregularVerbsArray[63][1] = "thought";
            irregularVerbsArray[63][2] = "thought";
            irregularVerbsArray[63][3] = "myśleć/sądzić";

            irregularVerbsArray[64][0] = "throw";
            irregularVerbsArray[64][1] = "threw";
            irregularVerbsArray[64][2] = "thrown";
            irregularVerbsArray[64][3] = "rzucać";

            irregularVerbsArray[65][0] = "wake";
            irregularVerbsArray[65][1] = "woke";
            irregularVerbsArray[65][2] = "woken";
            irregularVerbsArray[65][3] = "budzić";

            irregularVerbsArray[66][0] = "wear";
            irregularVerbsArray[66][1] = "wore";
            irregularVerbsArray[66][2] = "worn";
            irregularVerbsArray[66][3] = "nosić";

            irregularVerbsArray[67][0] = "undersand";
            irregularVerbsArray[67][1] = "understood";
            irregularVerbsArray[67][2] = "understood";
            irregularVerbsArray[67][3] = "rozumieć";

            irregularVerbsArray[68][0] = "win";
            irregularVerbsArray[68][1] = "won";
            irregularVerbsArray[68][2] = "won";
            irregularVerbsArray[68][3] = "wygrywać";

            irregularVerbsArray[69][0] = "write";
            irregularVerbsArray[69][1] = "wrote";
            irregularVerbsArray[69][2] = "written";
            irregularVerbsArray[69][3] = "pisać";
